...
%function [X,theta,iSelect] = selectRegionAroundZero(O1,O2,O3,oTheta,oThetaMira,phiSimulation,varargin)%function [X,theta,iSelect] = selectRegionAroundZero(O1,O2,O3,oTheta,varargin)
